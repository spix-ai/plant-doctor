...
import PredictedCard from '../screens/PredictedCard';
  ...
  return (
    <Stack.Navigator initialRouteName="Articles" mode="card" headerMode="screen">
      <Stack.Screen name="Articles" component={Articles} options={{
        header: ({ navigation, scene }) => (<Header title="PredictedCard" navigation={navigation} scene={scene} />),
        backgroundColor: '#FFFFFF'
      }} />
    </Stack.Navigator>
  );
  ...
  return (
    <Stack.Navigator initialRouteName="Chat" mode="card" headerMode="screen">
      <Stack.Screen name="Chat" component={Chat} options={{
        header: ({ navigation, scene }) => (<Header title="Chat" navigation={navigation} scene={scene} />),
        backgroundColor: '#FFFFFF'
      }} />
    </Stack.Navigator>
  );
...
function AppStack(props) {
  return (
    <Drawer.Navigator
      ...
      drawerStyle={{
        backgroundColor: nowTheme.COLORS.SPIXLIGHT,
        width: width * 0.8
      }}
